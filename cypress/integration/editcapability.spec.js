describe('Edit Capability task', () => {
    ...
    it('Test Edit Capability of Task', () => {
            ...
            cy.get('.ant-select-item-option').eq(4).should('not.have.text', 'Select')
            ...
            cy.get('.ant-modal-body').find('.ant-input').eq(1).clear().type('test')
            cy.get('.ant-modal-body').find('.ant-input').eq(1).should('not.have.text', ' ')
            cy.get('.attachment-item').find('button').click()
            cy.get('.ant-modal-body').find('.ant-input').eq(2).clear().type('www.wwe.com')
