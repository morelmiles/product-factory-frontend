describe('Capability task', () => {
    ...
    it('Test Create Capability Task', () => {
            ...
            cy.wait(2000)
            cy.get('.ant-layout-content').find('.ant-btn').eq(1).click()
            ...
            cy.get('.ant-modal-body').find('.ant-input').eq(1).type('www.wwe.com')
            ...
            cy.wait(2000)
            cy.get('.ant-modal-body').eq(1).find('.ant-input').type('www.url.com')
