...
const TaskTab: React.FunctionComponent<Props> = ({ setTaskNum, sortedBy, statuses, showInitiativeName= false, tags }) => {
  ...
  return (
    <TaskTable submit={() => refetch()} tasks={data.tasks} statusList={data.statusList} showInitiativeName={showInitiativeName} hideTitle={true} />
  );
};
