...
const HeaderMenuContainer: React.SFC = ({
  history, location, match, user, userLogInAction, setUserRole
}) => {
        ...
        <div className='login-container'>
          ...
          />
          {
            user && user.isLoggedIn ? (
              ...
              <Button
                className="signIn-btn"
                onClick={() => history.push("/switch-test-user")}
              >
                Sign in
              </Button>    
            )
